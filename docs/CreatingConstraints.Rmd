...
$$latex
  V_z(a) = \max_{a'} u(a'-(1+r) \cdot a) + \frac{1}{1+R} E_{z'|z} V_{z'}(a')
$$
...
The last equation we need to garantee optimally, is the first order condition. I need to finish this.
